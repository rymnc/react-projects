      ...
      <div className="card border-info">
        ...
        <div className="card-body">
          <div className="form-group mx-3 my-3">
              <input type="text" value={desc} onChange={handleChange1} name="Thing" id="1" className="form-control my-3" placeholder='Entry'/>
              <input type="number" value={money} onChange={handleChange2} name="Value" id="2" placeholder='Amount' className='form-control my-3'/>
